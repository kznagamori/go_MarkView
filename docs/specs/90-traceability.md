...
| IMP-150 | config 型定義 | UI-110, UI-111, UI-115, NFR-042 |
...
| IMP-170 | 外部委譲 | FR-053, UI-102 |
| IMP-175 | OS のテーマ設定の取得 | FR-071 |
| IMP-180 | バージョン情報 | BR-030, BR-080 |
| IMP-181 | 同梱資産の情報 | FR-100, BR-042, BR-043, NFR-034 |
| IMP-190 | App が保持する状態 | FR-030, UI-111, NFR-042 |
| IMP-191 | 表示履歴 | FR-051 |
| IMP-192 | 文書を開く共通処理 | FR-010, FR-011, FR-015, FR-030, FR-033, FR-050 |
...
| IMP-310 | バインドメソッド一覧 | FR-010, FR-015, FR-033, FR-035, FR-061, UI-090, UI-110, AR-061, AR-062 |
...
| DSP-182 | 状態画面のボタン | FR-016, UI-052 |
