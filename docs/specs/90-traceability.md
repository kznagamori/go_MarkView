...
- 1 つの要求が複数の仕様に分かれる場合、実現の主たるものを先に書く。
...
| FR-011 | ドラッグ＆ドロップによる表示 | IMP-192, IMP-245, IMP-313 | DSP-190 |
| FR-012 | コマンドライン引数による起動 | IMP-193 | — |
| FR-013 | 引数なし起動時の動作 | IMP-193, IMP-211 | DSP-181, DSP-300 |
| FR-014 | ファイル更新の自動検知と再描画 | IMP-140, IMP-141, IMP-142, IMP-321 | DSP-350 |
| FR-015 | 手動での再読み込み | IMP-192, IMP-310 | DSP-350 |
| FR-016 | 大きなファイルの扱い | IMP-101, IMP-102, IMP-250, IMP-308, IMP-314 | DSP-181, DSP-300, DSP-182 |
| FR-020 | Markdown の描画 | IMP-110, IMP-111, IMP-220 | DSP-121 |
...
| FR-030 | ツリールートの決定 | IMP-190, IMP-192 | DSP-302 |
| FR-031 | ツリーの表示内容 | IMP-105, IMP-132, IMP-133 | DSP-112 |
...
| FR-050 | 文書内リンクの遷移 | IMP-192, IMP-223, IMP-312 | DSP-350 |
| FR-051 | 表示履歴の前後移動 | IMP-191, IMP-311 | DSP-350 |
| FR-052 | ツリールート外の文書を開いた場合 | IMP-302 | DSP-112, DSP-150, DSP-330 |
| FR-053 | 画像の表示先 | IMP-170, IMP-312 | — |
| FR-060 | コピーボタンの表示 | IMP-115, IMP-221 | DSP-251 |
| FR-061 | コピー動作 | IMP-221, IMP-310 | DSP-252 |
| FR-062 | 選択範囲のコピー | IMP-244 | — |
| FR-070 | テーマの切り替え | IMP-243, IMP-231 | DSP-011, DSP-370 |
| FR-071 | 初回起動時のテーマ | IMP-151, IMP-175, IMP-303 | DSP-011 |
| FR-080 | 文書内検索 | IMP-241 | DSP-160, DSP-161, DSP-360, DSP-361 |
...
| FR-100 | アプリケーション情報ウィンドウ | IMP-181, IMP-251, IMP-306 | DSP-170, DSP-171 |
| FR-101 | OSS ライセンス表示 | IMP-030, IMP-306 | DSP-171 |
| FR-110 | エラー通知 | IMP-021, IMP-307, IMP-308, IMP-315 | DSP-151, DSP-181 |
| FR-111 | 異常終了の回避 | IMP-022, IMP-250 | DSP-181, DSP-300 |
...
| UI-011 | ウィンドウの初期サイズ | IMP-193 | DSP-030 |
| UI-012 | 高 DPI 対応 | — | DSP-381 |
| UI-013 | ウィンドウタイトル | IMP-302 | DSP-302 |
| UI-020 | ツールバーのボタン配置 | IMP-202, IMP-203 | DSP-100, DSP-032 |
| UI-021 | ボタンの状態表現 | IMP-295 | DSP-101 |
| UI-022 | アイコンの仕様 | IMP-203 | DSP-014 |
| UI-023 | ツールバーの高さと余白 | — | DSP-030, DSP-032 |
| UI-024 | ツールチップの文言と UI テキストの言語 | IMP-247, IMP-290 | DSP-102 |
| UI-025 | アプリケーションアイコン | IMP-032, IMP-160, IMP-251 | DSP-017, DSP-171 |
| UI-026 | 狭いウィンドウでのペインの一時的な非表示 | IMP-246 | DSP-380 |
| UI-030 | ファイルツリーペインの表示仕様 | IMP-240 | DSP-110, DSP-112, DSP-114 |
| UI-031 | ファイルツリーのキーボード操作 | IMP-295 | DSP-330 |
| UI-040 | アウトラインペインの表示仕様 | IMP-224, IMP-240 | DSP-110, DSP-113 |
| UI-041 | ペインの並び順 | IMP-202 | DSP-310 |
| UI-050 | 本文ペインの表示仕様 | IMP-220 | DSP-120, DSP-122 |
| UI-051 | スクロール | — | DSP-350 |
| UI-052 | 本文ペインに表示する状態画面 | IMP-250 | DSP-180, DSP-181, DSP-182, DSP-300 |
| UI-060 | ステータス領域 | IMP-302 | DSP-150, DSP-151 |
| UI-070 | ドロップ領域の表示 | IMP-245 | DSP-190 |
| UI-080 | 検索バーの表示仕様 | IMP-241 | DSP-160 |
| UI-090 | キーボードショートカット | IMP-244, IMP-310 | DSP-102 |
| UI-100 | アプリケーション情報ウィンドウ | IMP-251 | DSP-170, DSP-171 |
| UI-101 | OSS ライセンス表示欄 | IMP-251 | DSP-171 |
| UI-102 | 情報ウィンドウ内リンクの扱い | IMP-170, IMP-251 | DSP-171 |
| UI-103 | エディタ選択ウィンドウ | IMP-172, IMP-252, IMP-309 | DSP-172 |
| UI-105 | テーマ配色の基準 | IMP-243 | DSP-010, DSP-011, DSP-012, DSP-370 |
| UI-110 | 設定として保存する項目 | IMP-150, IMP-303, IMP-310 | DSP-310 |
| UI-111 | 設定として保存しない項目 | IMP-150, IMP-190, IMP-194, IMP-210, IMP-242 | — |
...
| UI-116 | エディタ指定の保存 | IMP-150, IMP-151, IMP-153 | — |
...
| MD-072 | 生 HTML の扱い（サニタイズ） | IMP-116 | — |
...
| AR-060 | ページ遷移の禁止 | IMP-223, IMP-251 | — |
| AR-061 | Go とフロントエンドの通信 | IMP-300, IMP-310, IMP-320 | — |
...
| 要求 | 概要 | 実装 | 表示 |
| --- | --- | --- | --- |
| NFR-010 | 起動時間 | IMP-193, IMP-211 | DSP-390 |
| NFR-011 | 変換・描画性能 | IMP-110, IMP-220, IMP-233 | — |
| NFR-012 | 操作の応答性 | IMP-222, IMP-240 | DSP-050 |
...
| NFR-035 | 外部プログラムの起動 | IMP-170, IMP-171, IMP-172, IMP-309 | — |
...
| NFR-061 | 表示の互換性 | — | DSP-001, DSP-272, DSP-381 |
| NFR-062 | 表示言語の一貫性 | IMP-290 | DSP-102 |
| NFR-070 | コード品質 | IMP-020, IMP-040 | — |
...
| IMP-030 | go:embed の構成 | AR-020, FR-101, NFR-021, NFR-051 |
| IMP-031 | ビルドタグ | AR-003, BR-002, BR-010, BR-011, NFR-060 |
...
| IMP-111 | goldmark の構成 | MD-022〜MD-026, MD-050, MD-051, MD-073, AR-031, AR-032 |
...
| IMP-220 | 本文の挿入 | FR-020, UI-050, AR-052, NFR-011 |
| IMP-221 | コピーボタン | FR-060, FR-061, AR-062 |
| IMP-222 | スクロール連動 | FR-042, AR-051, NFR-012 |
| IMP-223 | リンククリックの捕捉 | FR-050, MD-070, AR-060 |
| IMP-224 | アウトラインの構築 | FR-040, FR-041, UI-040 |
| IMP-225 | GitHub Alerts のアイコン付与 | MD-040, MD-072 |
| IMP-226 | 画像の読み込み失敗 | FR-022, FR-111 |
| IMP-227 | 見出しのアンカー | MD-020, MD-021 |
| IMP-230 | Mermaid・KaTeX・PlantUML の遅延ロード | AR-021, MD-061, MD-082, MD-085, FR-024, NFR-013, NFR-032 |
...
| IMP-240 | ペインの開閉とリサイズ | FR-034, FR-043, UI-030, UI-040, UI-114, NFR-012 |
| IMP-241 | 検索 | FR-080, UI-080 |
...
| IMP-310 | バインドメソッド一覧 | FR-010, FR-015, FR-033, FR-035, FR-061, FR-090, FR-091, UI-090, UI-110, AR-061, AR-062 |
...
| IMP-320 | イベント一覧 | FR-011, FR-014, FR-030, FR-110 |
...
| DSP-011 | テーマの適用機構 | FR-070, FR-071, UI-105 |
...
| DSP-121 | 本文要素 | MD-022〜MD-026, MD-033, MD-050, MD-070 |
| DSP-122 | 表 | MD-024, UI-050 |
| DSP-123 | 画像 | FR-022, MD-071 |
...
| DSP-350 | スクロール位置の契機ごとの挙動 | FR-014, FR-015, FR-041, FR-050, FR-051, UI-051 |
...
- 要求仕様書の要求一覧に現れる ID が、本文書の正引き表にすべて現れること。
