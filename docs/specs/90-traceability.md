...
| UI-111 | 設定として保存しない項目 | IMP-150, IMP-190, IMP-210 | — |
| UI-112 | 設定の保存先 | IMP-152 | — |
...
| NFR-031 | ファイルアクセスの制限 | IMP-025, IMP-161 | — |
...
| IMP-150 | config 型定義 | UI-110, UI-111, NFR-042 |
| IMP-151 | 読み書き | UI-113, FR-071, NFR-050 |
| IMP-152 | 保存先の解決 | UI-112, NFR-033 |
| IMP-153 | 値の範囲 | UI-113 |
...
| IMP-193 | 起動シーケンス | FR-012, FR-013, UI-011, AR-080, NFR-010 |
| IMP-194 | 終了処理 | UI-114 |
...
| IMP-303 | InitialStateDTO | FR-071, UI-110 |
