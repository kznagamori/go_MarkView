...
> [!NOTE]
> 本文書が扱うのは要求 ↔ 実装 ↔ 表示の 3 層である。**要求 ↔ 単体テストの対応は [31 章 31.10](31-test-cases.md) にある。** テストの追加・削除はケース側の変更が主であり、そちらで管理するほうが更新漏れが起きにくいため、意図的に分けている。
...
| NFR-061 | 表示の互換性 | — | DSP-001, DSP-381 |
...
| IMP-230 | Mermaid と KaTeX の遅延ロード | AR-021, MD-061, MD-082, NFR-013, NFR-032 |
...
| IMP-300 | 設計原則 | AR-061 |
| IMP-301 | 命名と型 | AR-061 |
| IMP-302 | DocumentDTO | UI-013, UI-060, FR-052 |
