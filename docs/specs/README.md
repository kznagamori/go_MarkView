...
手動テストの実施記録は `tests/MarkView_手動テスト仕様書.xlsx` に記入する。このファイルは 41 章から生成されるものであり、**ケースの定義は 41 章が正**である（E2E-200）。
...
| リリース前に確認する | [40](40-e2e-auto.md)（自動テストの結果）→ [41](41-e2e-manual.md) と `tests/` の Excel（手動確認） |
